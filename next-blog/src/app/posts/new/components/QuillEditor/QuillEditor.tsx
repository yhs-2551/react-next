            ...
            if (quillRef.current) {
              ...
              if (range) {
                ...
                if (leaf && (leaf.domNode as HTMLElement).tagName === "IMG") {
                  ...
                  // Delta를 확인하는 코드 추가
                  const delta = quill.getContents(); // 현재 Delta 가져오기
                  ...
                  delta.ops.forEach((op) => {
                    if (
                      ...
                      // 크기를 Delta에 저장한 경우
                      console.log("Image Width:", op.attributes?.width);
                      console.log("Image Height:", op.attributes?.height);
                    }
                  });
                }
              }
