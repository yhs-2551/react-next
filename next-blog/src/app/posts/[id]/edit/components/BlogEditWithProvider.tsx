...
//     const handlePublish: (postStatus: "PUBLIC" | "PRIVATE", commentsEnabled: "ALLOW" | "DISALLOW", featuredImage: FileMetadata | null | undefined) => void = (
...
//                     console.error("Error:", error.message); // 오류 로그 확인
...
// function BlogEditWithProvider({ initialData, postId }: { initialData: PostResponse; postId: string }) {
//     return (
//         <ClientWrapper>
...
// export default BlogEditWithProvider;
