...
export default function PostNotFound() {
    // 삭제시에 not-found 걸리지 않기 위해 일시적으로 추가
        ...
        <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100'>
            ...
            >
                <motion.div initial={{ y: -20 }} animate={{ y: 0 }} className='mb-6'>
                    <span className='text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-600'>404</span>
                </motion.div>
                <h2 className='text-2xl font-bold text-gray-800 mb-4'>게시글을 찾을 수 없습니다.</h2>
                <p className='text-gray-600 mb-8'>요청하신 게시글이 존재하지 않거나 삭제되었을 수 있습니다.</p>
                <Link
                    href='/'
